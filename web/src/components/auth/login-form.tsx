  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit}>
      ...
      {twoFactorRequired ? (
        <div className="space-y-1.5">
          <div className="flex items-center justify-between">
            <label htmlFor="two-factor-code" className="text-xs text-surface-subtle">
            ...
            <button
              ...
              className="bg-transparent p-0 text-xs text-accent transition-colors hover:text-white"
            >
          ...
          <p className="text-xs text-surface-subtle">
            We&apos;ll ask for a code each time two-factor is enabled.
          </p>
        </div>
      ) : null}
      ...
      <p className="text-xs text-surface-subtle">
        No account yet?{" "}
        <Link href="/register" className="text-accent transition-colors hover:text-white">
          Create one
        </Link>
        .
      </p>
